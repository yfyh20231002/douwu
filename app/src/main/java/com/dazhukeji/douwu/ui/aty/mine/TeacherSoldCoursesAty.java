 ...
 * 功能描述：老师已售课程
 */
public class TeacherSoldCoursesAty extends BaseAty {
    ...
    public void initData() {
        ...
        list.add(new Object());
        list.add(new Object());
        mRecyclerView.setAdapter(new TeacherSoldCourseAdapter(R.layout.item_sold_courses,list));
    }
    ...
    public class  TeacherSoldCourseAdapter extends BaseQuickAdapter<Object,BaseViewHolder>{
        public TeacherSoldCourseAdapter(int layoutResId, @Nullable List<Object> data) {
