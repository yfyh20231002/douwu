 ...
 */
public class DanceCourseDetailsAty extends BaseAty {
...
//        GlideApp.with(this).load("http://jzvd-pic.nathen.cn/jzvd-pic/1bb2ebbe-140d-4e2e-abd2-9e7e564f71ac.png").into(videoplayer.thumbImageView);
    ...
    public void initData() {
        ...
        Observable<ResponseBody> observable = apiService.postOrganizationCurriculumDetails(requestMap);
                ...
                .subscribe(new DisposableObserver<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody responseBody) {
                         ...
                         * {
                         ...
                         "curriculum_state": 1,
                         "curriculum_false_delete": 1,
                         "curriculum_effective": 2,
     ...
     * @param data
     */
    private void exChangeCollectState(Map<String, String> data) {
