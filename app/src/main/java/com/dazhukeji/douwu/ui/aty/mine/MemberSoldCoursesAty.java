 ...
 * 功能描述：会员已购课程
 */
public class MemberSoldCoursesAty extends BaseAty {
    ...
    public void initView() {
        ...
        list.add(new Object());
        list.add(new Object());
        mRecyclerView.setAdapter(new MemberSoldCourseAdapter(R.layout.item_course_manage,list));
    }
    ...
    public class  MemberSoldCourseAdapter extends BaseQuickAdapter<Object,BaseViewHolder> {
        public MemberSoldCourseAdapter(int layoutResId, @Nullable List<Object> data) {
